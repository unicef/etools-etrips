describe('Supervised', function() {
    ...
    it('should have the correct number of trips', function() {    
        element.all(by.css('ion-view[view-title="Supervised"] ion-item.item-avatar')).count().should.eventually.equal(2);
    });
    ...
    it('should be able to pull to refresh', function() {
        ...
        var trips = element.all(by.css('ion-view[view-title="Supervised"] ion-item.item-avatar'));
